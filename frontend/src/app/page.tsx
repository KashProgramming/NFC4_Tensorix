    ...
    <div className="font-sans min-h-screen bg-[#0a0a0a] text-white">
      ...
      <nav className="flex justify-between items-center p-6 max-w-7xl mx-auto">
        ...
        <div className="hidden md:flex gap-8">
          <a
            href="#features"
            className="hover:text-[#853DCC] transition-colors"
          >
            Features
          </a>
          <a
        ...
        {user ? (
          <div className="flex items-center gap-4">
            ...
            <button
              onClick={logout}
              className="bg-[#853DCC] hover:bg-[#0d9668] text-white px-5 py-2 rounded-full transition-colors inline-block"
            >
              Logout
            </button>
          </div>
      ...
      <section className="px-6 pb-32 max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row items-center gap-12">
          <div className="md:w-1/2 space-y-6">
            <div className="flex items-center gap-2">
              <span className="bg-[#1e293b] text-[#853DCC] px-3 py-1 rounded-full text-sm font-medium">
                New
              </span>
              <span className="text-gray-400">
                AI-Powered Screenplay Enhancement
              </span>
            </div>
            <h1 className="text-4xl md:text-5xl font-bold leading-tight">
              Transform Your <span className="text-[#853DCC]">Scripts</span>{" "}
              with AI Intelligence
            </h1>
            <p className="text-gray-400 text-lg">
              ScriptGenius revolutionizes screenplay writing with advanced AI
              that analyzes character arcs, enhances dialogue authenticity, and
              ensures narrative consistency. From first draft to final cut,
              elevate every scene with intelligent suggestions.
            </p>
            {user ? (
              <a
                href="/enhancer"
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                <a
                  href="/register"
                  className="bg-[#853DCC] hover:bg-[#0d9668] text-white px-6 py-3 rounded-full transition-colors flex items-center justify-center gap-2"
                >
                ...
                <a
                  href="/login"
                  className="border border-gray-700 hover:bg-gray-800 px-6 py-3 rounded-full transition-colors flex items-center justify-center gap-2"
                >
                ...
                <div className="bg-gradient-to-b from-[#111] to-[#0f0f0f] border-2 border-gray-800 text-white p-4 rounded-t-3xl shadow-2xl transform -rotate-12 origin-bottom-left relative z-10 h-24">
                  <div className="flex justify-between items-center h-full">
                    <div className="flex items-center gap-6">
                      <div className="font-bold text-2xl text-[#853DCC] tracking-wider pl-4">
                        SCRIPTGENIUS
                      </div>
                      <div className="text-sm text-gray-400 bg-[#1e293b] px-3 py-1 rounded">
                        SCENE 1
                      </div>
                    </div>
                  ...
                  <div className="relative z-10 h-full flex flex-col">
                    ...
                    <div className="pt-3 border-t-2 border-gray-800 grid grid-cols-4 gap-4 text-sm">
                      <div className="text-center">
                        <div className="text-[#853DCC] font-bold text-xs mb-1">
                          CHARACTER
                        </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold mb-4">
              Powerful <span className="text-[#853DCC]">Features</span>
            </h2>
            <p className="text-gray-400 max-w-2xl mx-auto">
              Our AI-powered tools help screenwriters enhance their scripts
              through tone detection, character analysis, and automatic dialogue
              improvements.
            </p>
          </div>
            ...
            {[
              {
                ...
                description:
                  "Get AI-powered suggestions to improve dialogue clarity, impact, and character voice.",
              },
              {
                icon: <Palette className="h-6 w-6 text-[#853DCC]" />,
                title: "Emotion & Tone Analysis",
                description:
                  "Analyze and refine the emotional tone of each scene for maximum impact.",
              },
              {
                icon: <CheckCircle className="h-6 w-6 text-[#853DCC]" />,
                title: "Character Consistency",
                description:
                  "Ensure your characters maintain consistent language and personality traits throughout.",
              },
              {
                icon: <FileText className="h-6 w-6 text-[#853DCC]" />,
                title: "Standard Formatting",
                description:
                  "Multi-character screenplay editor with industry-standard formatting support.",
              },
              {
                icon: <Sparkles className="h-6 w-6 text-[#853DCC]" />,
                title: "AI Punchlines",
                description:
                  "Generate alternative dialogue options and punchlines to enhance your script.",
              },
              {
                icon: <Download className="h-6 w-6 text-[#853DCC]" />,
                title: "Export Options",
                description:
                  "Export your enhanced screenplay to PDF, Fountain, or Final Draft format.",
              },
            ].map((feature, index) => (
              <div
                key={index}
                className="bg-[#111] border border-gray-800 rounded-xl p-6 hover:border-[#853DCC]/50 transition-colors"
              >
      ...
      <section className="px-6 py-20">
        <div className="max-w-4xl mx-auto bg-gradient-to-r from-[#1e293b] to-[#111] rounded-2xl p-8 md:p-12 text-center">
          <h2 className="text-3xl font-bold mb-4">
            Ready to Transform Your Screenplay?
          </h2>
          <p className="text-gray-400 mb-8 max-w-2xl mx-auto">
            Join thousands of screenwriters who are using AI to enhance their
            creative process and produce professional-quality scripts.
          </p>
          {user ? (
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="/enhancer"
              className="bg-[#853DCC] hover:bg-[#0d9668] text-white px-6 py-3 rounded-full transition-colors inline-block text-center"
            >
              Start Enhancing
            </a>
          </div>
            ...
            <a
              href="/login"
              className="border border-gray-700 hover:bg-gray-800 px-6 py-3 rounded-full transition-colors inline-block text-center"
            >
              Sign In
            </a>
          </div>)}
      ...
      <footer className="px-6 py-12 border-t border-gray-800">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
          ...
          <div className="flex gap-8">
            <a
              href="#features"
              className="text-gray-400 hover:text-[#853DCC] transition-colors"
            >
              Features
            </a>
            <a
